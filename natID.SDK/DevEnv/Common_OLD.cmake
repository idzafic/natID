...
if (WIN32)
	...
	set(RAM_DISK C:/RAMDisk)
else()
    #output folder - RamDisk
	set(RAM_DISK ${HOME_ROOT}/RAMDisk)
endif()
	...
	elseif (APPLE)
	  set_target_properties(${targetID} PROPERTIES
		...
		if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/.vscode/settings.json")
			...
			file(READ "${NATID_SDK_ROOT}/DevEnv/VSCodeDebugger/settings.json" VSCODE_SETTINGS_FILE)
...
function(setIDEPropertiesForGUIExecutable targetID devResPath)
	...
	if (NOT EXISTS "${DevResPaths_PATH}") #update devResPaths.txt file
