...
public:
    ...
    public:
        gui::Size viewSize;
        int delayAfterPlacementInMs = 200; //200 ms
...
protected:
    ...
    float _originXMargin = 0.045f;   //relative to biard width, after fine-tuning
    float _originYMargin = 0.045f;    //relative to board height
    Options _options;
