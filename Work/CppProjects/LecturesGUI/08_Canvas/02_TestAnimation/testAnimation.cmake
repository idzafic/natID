...
set(TESTANIMATION_PLIST  ${CMAKE_CURRENT_LIST_DIR}/src/Info.plist)
file(GLOB TESTANIMATION_INC_TD  ${MY_INC}/td/*.h)
file(GLOB TESTANIMATION_INC_GUI ${MY_INC}/gui/*.h)

# add executable
add_executable(${TESTANIMATION_NAME} ${TESTANIMATION_INCS} ${TESTANIMATION_SOURCES} ${TESTANIMATION_INC_TD}  ${TESTANIMATION_INC_GUI})
