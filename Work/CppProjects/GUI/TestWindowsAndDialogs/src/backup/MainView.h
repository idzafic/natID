...
//                _textEdit.clean();
        ...
        {
            //gui::modal::view<ViewLoginForDlg>([](gui::Dialog* pDlg)
            //    {
            //        if (pDlg->getClickedButtonID() == gui::Dialog::Button::ID::OK)
            //        {
            //            DialogLogin* pDlgLogin = (DialogLogin*) pDlg;
            ...
            //    }, pBtn);
            ////ili ovako:
            //gui::modal::view<ViewLoginForDlg>(pBtn, [](gui::Dialog* pDlg)
            //    {
            //        if (pDlg->getClickedButtonID() == gui::Dialog::Button::ID::OK)
            //        {
            //            DialogLogin* pDlgLogin = (DialogLogin*)pDlg;
            ...
            //gui::modal::view<ViewLoginForDlg, gui::Dialog::Button::ID::OK>(pBtn, [](gui::Dialog* pDlg)
            //    {
            //        //if (pDlg->getClickedButtonID() == gui::Dialog::Button::ID::OK)
            //        {
            //            DialogLogin* pDlgLogin = (DialogLogin*)pDlg;
            ...
            gui::modal::view<ViewLoginForDlg>(pBtn);

            ////ili ovako za samo jedan btn
            //gui::modal::view<ViewLoginForDlg, gui::Dialog::Button::ID::Close>(pBtn);
