...
class ViewChess : public gui::gl::OrthoView
{
...
private:
    ...
    void loadTexture()
    {
        ...
        int width = _textureChess1.getWidth();
        int height = _textureChess1.getHeight();
        auto texBytes = _textureChess1.getBytes();
        ...
        width = _textureChess2.getWidth();
        height = _textureChess2.getHeight();
        texBytes = _textureChess2.getBytes();
    ...
    void setupVBO()
    {
        ...
        gui::gl::Point2d rectVertices[] =
        {
            ...
            {c, -c},
            {c,  c},
            {-c,  c} //end of rect data
        };
        
        gui::gl::Point2d  textureCoords[] =
        {
            {0.0f, 0.0f},  // Texture coordinate for Vertex 1
            {4.0f, 0.0f},  // Texture coordinate for Vertex 2
            {4.0f, 4.0f},   // Texture coordinate for Vertex 3
            {0.0f, 4.0f}   // Texture coordinate for Vertex 4
        };
