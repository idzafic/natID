...
protected:
    ...
    void populateThreadMenu()
    {
        ...
        items[2].initAsActionItem(tr("Easy"), 20);
        items[2].setAsCheckable();

        items[3].initAsActionItem(tr("Medium"), 21);
        items[3].setAsCheckable();

        items[4].initAsActionItem(tr("Hard"), 22);
        items[4].setAsCheckable();
    }
public:
    MenuBar()
