...
public:
    ...
    , _btnLblFontInfo("Label font info")
    , _btnClearText("Brisi")
...
//        _textEdit.appendString("\t");
    ...
    bool onClick(gui::Button* pBtn) override
    {
        ...
        else if (pBtn == &_btnLblFontInfo)
        {
            gui::Font font;
            _lbl.getFontDescription(font);
            td::String str;
            str.format(" FN=%s, %1.f, bold=%d ", font.getFamilyName().c_str(), font.getSize(), (font.isBold()? 1 : 0));
