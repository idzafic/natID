...
constexpr bool showNonBezierPrimitives = true;
...
protected:
    ...
    gui::Shape _shapeBezier; //Bezier shape
    gui::Shape _lineBez1; //Bezier shape
    gui::Shape _lineBez2; //Bezier shape
    gui::Shape _lineBez3; //Bezier shape
    
    gui::Image _img;
    gui::Symbol _symbol;
    gui::Symbol _symbolBez1; //Symbol with Bezier paths
    gui::Symbol _symbolBez2; //Symbol with Bezier paths
...
public:
    ...
    , _symbolBez1(":Bez1")
    , _symbolBez2(":Bez2")
    , _drawableString("This is text drawing by DrawableString! The text is a bit longer (for demonstration purposes) ...")
    {
