...
protected:
    ...
    void populateFrameMenu()
    {
        ...
        items[0].initAsActionItem(tr("Export"), 30, "e");
    }
public:
    MenuBar()
    : gui::MenuBar(2) //two menus
    , subApp(20, tr("App"), 3) //allocate items for the Application subMenu
    , subEdit(20, tr("Frame"), 1) //allocate items for the Edit subMenu
    {
        populateSubAppMenu();
        populateFrameMenu();
        _menus[0] = &subApp;
