...
protected:
    ...
    void populateSubFileMenu()
    {
        ...
        //submenu items
        {
            ...
            itemsSubMenu[0].initAsActionItem(tr("Submenu1"), 10, "<Ctrl><Alt>1");
            itemsSubMenu[1].initAsActionItem(tr("Submenu2"), 20, "<Ctrl><Alt>2");
        }
    ...
    void populateSubViewMenu()
    {
        ...
        items[3].initAsActionItem(tr("LargeIconSize"), 30, "<Alt>L"); //icon size small <-> regular
