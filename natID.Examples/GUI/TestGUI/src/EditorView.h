...
public:
    EditorView()
    : gui::Canvas({gui::InputDevice::Event::CursorEnterLeave, gui::InputDevice::Event::PrimaryClicks,gui::InputDevice::Event::SecondaryClicks, gui::InputDevice::Event::Zoom})
    , _pointer(":pointer")
    , _bus(":bus")
...
//        pts[11].x=10; pts[11].y=2;
        _grLine.createPolygon(pts, sizeof(pts)/sizeof(gui::Point), true);
    }
...
//        _modelBoundRect.drawWire(td::ColorID::SysText);
        ...
        gui::Shape::drawRect(_rETF_VStretch, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_VTop, gui::Image::AspectRatio::Keep, td::HAlignment::Left, td::VAlignment::Top);
        gui::Shape::drawRect(_rETF_VTop, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_VCenter, gui::Image::AspectRatio::Keep, td::HAlignment::Left, td::VAlignment::Center);
        gui::Shape::drawRect(_rETF_VCenter, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_VBottom, gui::Image::AspectRatio::Keep, td::HAlignment::Left, td::VAlignment::Bottom);
        gui::Shape::drawRect(_rETF_VBottom, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
...
//        _gsVBottom.drawWire(td::ColorID::SysText);
        ...
        gui::Shape::drawRect(_rETF_HStretch, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_HLeft, gui::Image::AspectRatio::Keep, td::HAlignment::Left, td::VAlignment::Top);
        gui::Shape::drawRect(_rETF_HLeft, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_HCenter, gui::Image::AspectRatio::Keep, td::HAlignment::Center, td::VAlignment::Top);
        gui::Shape::drawRect(_rETF_HCenter, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        _etf.draw(_rETF_HRight, gui::Image::AspectRatio::Keep, td::HAlignment::Right, td::VAlignment::Top);
        gui::Shape::drawRect(_rETF_HRight, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
...
//        _text3.draw(td::ColorID::Magenta);
        ...
        gui::Rect rectForDrawableStr(500, 800, 600, 850);
        _drawableString.draw(rectForDrawableStr, gui::Font::ID::SystemNormal, td::ColorID::Orange);
        gui::Shape::drawRect(rectForDrawableStr, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        
        //draw rotated string
        {
            gui::Context ctx;
            gui::Transformation tr;
            tr.translate(rectForDrawableStr.left, rectForDrawableStr.top-5);
            tr.rotateDeg(-90);
            tr.appendToContext();
            gui::Rect rect2(0,0, 100, 50);
            _drawableString.draw(rect2, gui::Font::ID::SystemNormal, td::ColorID::Orange);
            gui::Shape::drawRect(rect2, td::ColorID::SysText, 1.0f, td::LinePattern::Dot);
        }
    }
