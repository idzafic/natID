...
protected:
    ...
    gui::Slider _slVertical;
    gui::ProgressIndicator _piVertical;
    ...
    gui::HorizontalLayout _hlEditorSlider;
...
public:
    ...
    , _slVertical(gui::DataCtrl::Orientation::Vertical, true)
    , _piVertical(gui::DataCtrl::Orientation::Vertical)
    ...
    , _vl(5)
    {
        ...
        _slVertical.setRange(0, 10, 5);
        
        _hlEditorSlider << _textEdit << _slVertical << _piVertical;
        
        //populate vertical layout
        _vl << _glUnAndPwd << _hlEditorSlider << _hlButtons;
        
        setLayout(&_vl);

        _slVertical.onChangedValue([this]()
            {
                auto val = _slVertical.getValue();
                _piVertical.setValue(val / 10.);
            });
    }
