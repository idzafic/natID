...
//            appProperties->setTBLabelVisibility(mu::IAppProperties::ToolBarType::Main, showLabels);
            bool restartFromInitialPosition = _viewSettings.shouldRestartFromInitialPosition();
            appProperties->setValue("restartFromInitialPosition", restartFromInitialPosition);
        }
        return true;
    }
public:
