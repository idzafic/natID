...
//            auto pApp = getApplication();
            ...
            bool showRoadNames = _viewSettings.showRoadNames();
            appProperties->setValue("showRoadNames", showRoadNames);
            
            bool showRoadLengths = _viewSettings.showRoadLengths();
            appProperties->setValue("showRoadLengths", showRoadLengths);
...
public:
    ...
    {
        return _viewSettings.showRoadNames();
    }
    
    bool showRoadLengths() const
    {
        return _viewSettings.showRoadLengths();
    }
