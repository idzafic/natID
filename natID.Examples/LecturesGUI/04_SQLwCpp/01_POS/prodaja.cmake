...
file(GLOB PRODAJA_TD  ${NATID_SDK_INC}/td/*.h)
file(GLOB PRODAJA_CNT  ${NATID_SDK_INC}/cnt/*.h)
file(GLOB PRODAJA_MU  ${NATID_SDK_INC}/mu/*.h)
file(GLOB PRODAJA_FO ${NATID_SDK_INC}/fo/*.h)
file(GLOB PRODAJA_DP ${NATID_SDK_INC}/dp/*.h)
file(GLOB PRODAJA_XML ${NATID_SDK_INC}/xml/*.h)
file(GLOB PRODAJA_ARCH ${NATID_SDK_INC}/arch/*.h)
