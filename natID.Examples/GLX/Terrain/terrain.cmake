...
add_executable(${TERRAIN_NAME} ${TESTGLX_INCS} ${TESTGLX_SOURCES} ${TESTGLX_INC_TD} ${TESTGLX_INC_GUI} ${TESTGLX_INC_GLX} ${TESTGLX_SHADERS})
...
setTargetPropertiesForGUIApp(${TERRAIN_NAME} ${TESTGLX_PLIST})

setIDEPropertiesForGUIExecutable(${TERRAIN_NAME} ${CMAKE_CURRENT_LIST_DIR})

setPlatformDLLPath(${TERRAIN_NAME})

registerShaderFolder(${TERRAIN_NAME} ${CMAKE_CURRENT_LIST_DIR}/res/shaders  "-e" "mainVS,mainFS")
