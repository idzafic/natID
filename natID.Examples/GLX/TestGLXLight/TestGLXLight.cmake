set(TESTLIGHT_NAME testLightGLX)
...
add_executable(${TESTLIGHT_NAME} ${TESTGLX_INCS} ${TESTGLX_SOURCES} ${TESTGLX_INC_TD} ${TESTGLX_INC_GUI} ${TESTGLX_INC_GLX} ${TESTGLX_SHADERS})
...
target_link_libraries(${TESTLIGHT_NAME} debug ${MU_LIB_DEBUG} optimized ${MU_LIB_RELEASE} 
...
setTargetPropertiesForGUIApp(${TESTLIGHT_NAME} ${TESTGLX_PLIST})

setIDEPropertiesForGUIExecutable(${TESTLIGHT_NAME} ${CMAKE_CURRENT_LIST_DIR})

setPlatformDLLPath(${TESTLIGHT_NAME})

registerShaderFolder(${TESTLIGHT_NAME} ${CMAKE_CURRENT_LIST_DIR}/res/shaders "-e" "mainVS,mainFS")
