set(TEST_GLX_INSTANCING_NAME testCameraAndInstancing)
...
# add executable
add_executable(${TEST_GLX_INSTANCING_NAME} ${TESTGLX_INCS} ${TESTGLX_SOURCES} ${TESTGLX_INC_TD} ${TESTGLX_INC_GUI} ${TESTGLX_INC_GLX} ${TESTGLX_SHADERS})
...
target_link_libraries(${TEST_GLX_INSTANCING_NAME} debug ${MU_LIB_DEBUG} optimized ${MU_LIB_RELEASE} 
									debug ${NATGUI_LIB_DEBUG} optimized ${NATGUI_LIB_RELEASE} 
								debug ${NATGLX_LIB_DEBUG} optimized ${NATGLX_LIB_RELEASE})


setTargetPropertiesForGUIApp(${TEST_GLX_INSTANCING_NAME} ${TESTGLX_PLIST})

setIDEPropertiesForGUIExecutable(${TEST_GLX_INSTANCING_NAME} ${CMAKE_CURRENT_LIST_DIR})

setPlatformDLLPath(${TEST_GLX_INSTANCING_NAME})

registerShaderFolder(${TEST_GLX_INSTANCING_NAME} ${CMAKE_CURRENT_LIST_DIR}/res/shaders "-e" "mainVS,mainFS")
