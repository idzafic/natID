...
file(GLOB TESTGLX_INC_MU ${NATID_SDK_INC}/mu/*.h)
...
# add executable
add_executable(${TESTGLX_NAME} ${TESTGLX_INCS} ${TESTGLX_SOURCES} ${TESTGLX_INC_TD} 
					${TESTGLX_INC_MU} ${TESTGLX_INC_GUI} ${TESTGLX_INC_GLX} ${TESTGLX_SHADERS})
...
source_group("inc\\mu"        FILES ${TESTGLX_INC_MU})
...
target_link_libraries(${TESTGLX_NAME} debug ${MU_LIB_DEBUG} optimized ${MU_LIB_RELEASE} 
									debug ${NATGUI_LIB_DEBUG} optimized ${NATGUI_LIB_RELEASE} 
								debug ${NATGLX_LIB_DEBUG} optimized ${NATGLX_LIB_RELEASE})



setTargetPropertiesForGUIApp(${TESTGLX_NAME} ${TESTGLX_PLIST})

setIDEPropertiesForGUIExecutable(${TESTGLX_NAME} ${CMAKE_CURRENT_LIST_DIR})

setPlatformDLLPath(${TESTGLX_NAME})

registerShaderFolder(${TESTGLX_NAME} ${CMAKE_CURRENT_LIST_DIR}/res/shaders  "-e" "mainVS,mainFS")
